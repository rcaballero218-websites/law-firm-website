      ...
      sections: [
        {
          ...
          imageSrc: "/lion.jpg",
          imageAlt: isSpanish
            ? "Símbolo de fortaleza y defensa"
            : "Lion symbol of strength and advocacy",
          imageLeft: false,
        ...
        },
        {
          ...
          imageAlt: isSpanish
            ? "Representación legal después de un accidente"
        ...
        },
        {
          ...
          imageSrc: "/lion.jpg",
          imageAlt: isSpanish
            ? "Guía después de un accidente"
            : "Guidance after an automobile accident",
          imageLeft: false,
          paragraphs: isSpanish
            ? [
        ...
        },
        {
          ...
          imageSrc: "/courtroom-hero.png",
          imageAlt: isSpanish
            ? "Ayuda con daños a la propiedad"
        ...
        },
        {
          ...
          imageSrc: "/lion.jpg",
          imageAlt: isSpanish
            ? "Reclamos de conductor sin seguro"
            : "Uninsured and underinsured motorist claims",
          imageLeft: false,
          paragraphs: isSpanish
            ? [
        ...
        },
        {
          ...
          imageSrc: "/lion.jpg",
          imageAlt: isSpanish
            ? "Representación en corte civil"
            : "Civil lawsuit and trial representation",
          imageLeft: false,
          paragraphs: isSpanish
            ? [
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", paddingTop: "60px" }}>
        ...
        <div style={heroWrap}>
          <video
            controls
            preload="metadata"
            poster={isSpanish ? "/auto-thumb-spanish.jpg" : "/auto-thumb.jpg"}
            style={heroVideo}
            key={isSpanish ? "spanish" : "english"}
          >
            <source
              src={isSpanish ? "/AA-Spanish-CC.mp4" : "/AA-English-CC.mp4"}
              type="video/mp4"
            />
