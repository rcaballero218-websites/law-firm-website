      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", paddingTop: "60px" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "40px auto" }}>
          <iframe
            ...
            src={
              isSpanish
                ? "https://www.youtube.com/embed/f_tTccnDjxY"
                : "https://www.youtube.com/embed/-BOkSw6KHEY"
            }
            title={
              isSpanish
                ? "Accidente de Trabajo en Maryland"
            ...
            key={isSpanish ? "workers-spanish-video" : "workers-english-video"}
          ></iframe>
        </div>
